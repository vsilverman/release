...
- [ ] Create a tag matching the LTS release you create in the [docker](https://github.com/jenkinsci/docker/) repository.
...
- [ ] Publish docker controller [GitHub release](https://github.com/jenkinsci/docker/releases).
